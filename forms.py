...
class TransactionForm(ModelForm):
	...
	class Meta:
		...
		fields = ['f_trans_id', 'f_user_id1', 'f_user_id2', 'f_ft_type', 'f_ft_quantity_unit', 'f_ft_quantity_number', 'f_ft_category', 'f_ft_description', 'f_pt_type', 'f_pt_quantity_unit','f_pt_quantity_number','f_pt_category', 'f_pt_description']
		...
		widgets = {'f_trans_id': forms.HiddenInput(), 'f_user_id1': forms.HiddenInput()}